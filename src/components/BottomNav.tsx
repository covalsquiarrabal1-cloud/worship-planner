...
import { Calendar, Users, Music, Settings, User, ListMusic, Mic, Wrench, BarChart3 } from 'lucide-react'
...
export function AdminBottomNav() {
  ...
  const items: NavItem[] = [
    ...
    { href: '/admin/ministerios', icon: <Mic className="w-6 h-6" />, label: 'Ministérios' },
